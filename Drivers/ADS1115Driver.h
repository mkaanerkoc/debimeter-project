...
typedef struct ADS1115InfoStruct
{
	int16_t  singleEndedChannel1;
	int16_t  singleEndedChannel2;
	int16_t  singleEndedChannel3;
	int16_t  singleEndedChannel4;
	int16_t  differential_0_1;
	int16_t  differential_2_3;
  int16_t  difference;
  float    voltageMv;
  float    currentMa;
  uint16_t height;
